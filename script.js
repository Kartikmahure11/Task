        ...
        $(document).ready(function () {
            ...
            if (emailId) {
                $.getJSON("https://script.google.com/macros/s/AKfycbw4uwR8USp1Pi3Y41yaTDdjncspmZQq-jF2MrUs2IN5MpEHLJbWFCgYzc1Fm2_ag-PQ/exec?emailId=" + encodeURIComponent(emailId), function (data) {
                    if (data.error) {
